...
const TevaTokenV1 = require("../../artifacts/contracts/token/TevaTokenV1.sol/TevaTokenV1.json");
...
async function main(hre: HardhatRuntimeEnvironment) {
  ...
  const TevaTokenArtifact = new ethers.ContractFactory(
    TevaTokenV1.abi,
    TevaTokenV1.bytecode,
    contractAdminWallet
  );
  const TevaTokenConstArgs: any = [];
  const TevaTokenContract = await TevaTokenArtifact.deploy();
